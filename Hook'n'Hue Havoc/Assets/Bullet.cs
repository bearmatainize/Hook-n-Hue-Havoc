...
public class Bullet : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            // Check if the collided object is not the player or bullet
            if (!collision.gameObject.CompareTag("Player") && !collision.gameObject.CompareTag("Bullet") && !collision.gameObject.CompareTag("Dummy"))
            {
